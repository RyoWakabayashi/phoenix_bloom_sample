defmodule PhoenixBloomSampleWeb do
  ...
  This can be used in your application as:
      ...
      use PhoenixBloomSampleWeb, :controller
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: PhoenixBloomSampleWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {PhoenixBloomSampleWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: PhoenixBloomSampleWeb.Endpoint,
        router: PhoenixBloomSampleWeb.Router,
        statics: PhoenixBloomSampleWeb.static_paths()
    end
  end
